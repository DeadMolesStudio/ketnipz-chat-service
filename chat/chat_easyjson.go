...
func easyjson9b8f5552DecodeChatChat(in *jlexer.Lexer, out *WSMessage) {
...
func easyjson9b8f5552EncodeChatChat(out *jwriter.Writer, in WSMessage) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson9b8f5552DecodeChatChat1(in *jlexer.Lexer, out *SendWSMessage) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson9b8f5552EncodeChatChat1(out *jwriter.Writer, in SendWSMessage) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
// MarshalJSON supports json.Marshaler interface
func (v SendWSMessage) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v SendWSMessage) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson9b8f5552EncodeChatChat1(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *SendWSMessage) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
...
// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *SendWSMessage) UnmarshalEasyJSON(l *jlexer.Lexer) {
